...
class BxMessengerModule extends BxBaseModTextModule
{
    ...
    public function checkAllowedView($aLot, $isPerformAction = false)
    {
        ...
        return $this->_oDb->isParticipant($aLot[$CNF['FIELD_ID']], $this->_iProfileId, true) === TRUE
                || $aLot[$CNF['FIELD_TYPE']] == BX_IM_TYPE_PUBLIC
                || $aLot[$CNF['FIELD_TYPE']] == BX_IM_TYPE_SETS ? CHECK_ACTION_RESULT_ALLOWED : CHECK_ACTION_RESULT_NOT_ALLOWED;
    }
